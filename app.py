...
with tab1:
    ...
    if import_image is not None:
        ...
        try:
            # Reading the image file as a PIL Image object
    ...
    # ----------------------------    /     Data processing and converting it into data frame   /   ------------------ #
    ...
    # --------------------------------------   /   Data Upload to Mysql   /   --------------------------------------- #
        ...
        if session_state.data_uploaded:
            ...
            engine = create_engine('mysql+mysqlconnector://root:1234@localhost/bizcard', echo=False)

            try:
                # Using sqlalchemy to insert the DataFrame into the SQL Database table
...
with tab2:
    ...
    with col1:
        ...
        try:
            ...
            # Executing the program if the button is clicked
            if session_state.data_update:

                # Updating the information for the selected business card in the database
                cursor.execute(
    ...
    with col2:
        ...
        try:
            ...
            delete = st.button('**Delete**', key = 'delet')
